/**
 * OURIN Plugin Compatibility Layer for Yuzuki MD
 * Wraps Yuzuki's APIs to match OURIN's m-style message API.
 */
...
/**
 * Create an OURIN-style message object from Yuzuki's raw msg + context.
 */
...
/**
 * OURIN-style database wrapper using Yuzuki's database.
 */
...
/**
 * OURIN-style level-up check using Yuzuki's addXP.
 */
...
/**
 * Format numbers with Indonesian locale (OURIN style).
 */
