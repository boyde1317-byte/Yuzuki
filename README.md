...
│   │   ├── ourin-compat.js   # Wraps Yuzuki APIs for OURIN plugin format
...
│   │       ├── feloai.js
│   │       └── chatexai.js
│   ├── plugins/              # Auto-loaded OURIN-format plugins (58 total)
...
## 🎨 OURIN UI/UX Merge — WhatsApp Message Tricks (v3)

> All ported from OURIN MD. Existing Yuzuki features enhanced where applicable.
