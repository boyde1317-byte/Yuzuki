# 🚀 Yuzuki MD V2 + OURIN MD Features Merge

This is an enhanced version of **Yuzuki MD V2** with **48+ plugins** ported from **OURIN MD 3**, plus **9 WhatsApp UI tricks** ported from OURIN's advanced message system — all without touching any existing Yuzuki code.
...
- **Compatibility Layer**: `src/lib/ourin-compat.js` — wraps Yuzuki APIs into OURIN's `m`-style message API
...
## 📦 Assets
All OURIN visual assets in `src/assets/ourin/`:
- Images: menu backgrounds, level-up cards, game screens
- Audio: `ourin-mp3.mp3`
- Video: `ourin-mp4.mp4`
- Fonts: `ourin-font.ttf`, `Epep.ttf`, `Levelup.ttf`, `Zahraaa.ttf`, `arialnarrow.ttf`
